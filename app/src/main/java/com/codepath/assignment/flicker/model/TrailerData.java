...
public class TrailerData {
    ...
    public static List<TrailerData> getListOfTrailers(JSONObject jsonObject){
        ...
        try{
            ...
            for(int i = 0; i < jsonArray.length(); i++){
                ...
                if(trailerObject != null){
                    TrailerData movieData = gson.fromJson(trailerObject.toString(), TrailerData.class);
                    trailers.add(movieData);
                }
            }
